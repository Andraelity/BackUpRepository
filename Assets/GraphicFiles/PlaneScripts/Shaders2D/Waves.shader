Shader "Shaders2D/Waves"
{
	...
	SubShader
	{
		...
		Pass
		{
            ...
            // Default 
            /////////////////////////////////////////////////////////////////////////////////////////////
			static float3 COLOR1 = float3(0.0, 0.0, 0.3);
			static float3 COLOR2 = float3(0.5, 0.0, 0.0);
			static float BLOCK_WIDTH = 0.01;
	...
	float4 fragColor = float4(final_color, 1.0);
